        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Architecting and deploying production-grade AI systems, from predictive models to sophisticated LLM-powered agents and RAG pipelines.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building scalable, high-throughput cloud infrastructure to containerize, deploy, and monitor machine learning microservices with robust CI/CD.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Dynatrace</div>
